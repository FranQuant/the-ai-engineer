...
| **3** | **FOMC Textual Surprise** | BPE tokenization, a decoder-only transformer built from scratch, and a pre-registered test of per-document surprise (bits per character) on FOMC statements and minutes. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/FranQuant/the-ai-engineer/blob/main/capstones/week03_transformers/week03_fomc_surprise.ipynb) |
